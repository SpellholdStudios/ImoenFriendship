...
<div align="center"><h1></a>Imoen Friendship</h1>
...
The Imoen Friendship mod should be compatible with all WeiDU mods, however, we cannot test every single one. It is only compatible with BGII: ToB. If you do encounter an error, please let us know by posting the message at our forums.

>Although it is not required for the Imoen Friendship to function properly, it is always a good idea to install the latest version of the <a href="http://www.gibberlings3.net/bg2fixpack/">BG2 Fixpack</a>.
...
<em>If you've previously installed the mod, remove it before extracting the new version. To do this, run **`setup-imoenfriendship.exe`**, un-install the previously installed main component and delete the :file_folder: imoenfriendship folder.</em>
...
In addition to the methods above for removing individual components, you can completely un-install the mod using **`setup-imoenfriendship --uninstall`** at the command line to remove all components without wading through prompts.</br>
<div align="right"><a href="#top">Back to top</a></div>
...
- Isaya and The d'Oghmatiques: French translation.
- Lava Del'Vortel: Polish translation.
- ArcaneCoast.ru (thanks to prowler and Ardanis_gen1e): Russian translation.
- Clan DLAN: Spanish Translation.
- Merzbau: Chinese translation.
...
###### The Imoen Friendship was developed by K'aeloree, based on material from the game Baldur's Gate II and its expansion. All mod content is &copy; K'aeloree.
